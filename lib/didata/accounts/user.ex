defmodule Didata.Accounts.User do
  @moduledoc false
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Didata.Repo)
  ...
  """
  def valid_password?(%Didata.Accounts.User{hashed_password: hashed_password}, password)
