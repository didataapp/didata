defmodule DidataWeb.Telemetry do
  @moduledoc false
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("didata.repo.query.total_time", unit: {:native, :millisecond}),
      summary("didata.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("didata.repo.query.query_time", unit: {:native, :millisecond}),
      summary("didata.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("didata.repo.query.idle_time", unit: {:native, :millisecond}),
