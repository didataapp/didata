defmodule DidataWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use DidataWeb.ConnCase, async: true`, although
  ...
  def register_and_login_user(%{conn: conn}) do
    user = Didata.AccountsFixtures.user_fixture()
  ...
  def login_user(conn, user) do
    token = Didata.Accounts.generate_session_token(user)
